	...
	var KeypadController = exports.KeypadController = function () {
	    ...
	    _createClass(KeypadController, [{
	        ...
	        value: function onKeyDown($event) {
	            ...
	            if (keyChar === 'Enter' && typeof this.bcSubmitMethod !== 'undefined') {
	                this.bcSubmitMethod();
	            }
